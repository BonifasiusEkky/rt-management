    ...
    return (
        <Layout>
            <div className="p-8 max-w-5xl mx-auto">
                <div className="mb-8">
                    <Link to="/rumah" className="text-blue-600 text-sm font-semibold hover:underline">← Kembali ke Peta</Link>
                    <h1 className="text-4xl font-black text-gray-900 mt-2">Rumah {r.label}</h1>
                    <p className="text-gray-500">Blok {r.blok}, Nomor {r.nomor_rumah}</p>
                </div>
